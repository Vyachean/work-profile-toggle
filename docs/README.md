...
This directory contains project documentation that should stay current with product and architecture changes.
...
Any change that affects user-facing behavior, product scope, setup, release process, testing, or planned work should update the relevant document in the same pull request.
